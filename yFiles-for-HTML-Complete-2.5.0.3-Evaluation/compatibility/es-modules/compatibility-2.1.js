...
import { yfiles } from 'yfiles'

// eslint-disable-next-line camelcase
export default function enable_2_1_compatibility() {
  if (yfiles.layout) {
    if (
    ...
    if (
      ...
      Object.defineProperty(yfiles.layout.LayoutGraphAdapter.prototype, 'improvePortAssignment', {
        get: function () {
          return this.portAdjustmentPolicy !== yfiles.layout.PortAdjustmentPolicy.NEVER
        },
        set: function (value) {
